            ...
            $stats = Cache::remember($cacheKey, 600, function () use ($user) {
                ...
                return [
                    'overall' => [
                        ...
                        'avg_wpm' => round(($competitions->avg('typing_speed') + $practices->avg('typing_speed')) / 2, 2), 
