...
<div class="container">
    <div class="mb-4">
        <a href="{{ route('guest.lessons') }}" class="btn btn-outline-secondary">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <div class="typing-practice mt-5">
                <h4>Practice Exercise</h4>
                <div class="alert alert-info">
                    <strong>Instructions:</strong> Type the text below to practice the lesson.
                </div>
                
                <div class="typing-container my-4 p-3 border rounded" id="typingContainer">
                    <div class="text-to-type mb-4" id="textToType">{{ $lesson->content }}</div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button id="startButton" class="btn btn-primary">Start Practice</button>
                    </div>
                </div>
                ...
                <div class="results-container d-none" id="resultsContainer">
                    ...
                    <div class="mt-4 text-center">
                        <p>Want to save your progress and earn experience points?</p>
                        <div>
    ...
    <div class="text-end mb-5">
        <a href="{{ route('guest.lessons.show', $nextLesson) }}" class="btn btn-primary">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function startTest() {
            ...
            startTime = new Date();
            testActive = true;
            startButton.textContent = 'Complete Practice';
        ...
        function resetTest() {
            ...
            // Hide results, show typing container
